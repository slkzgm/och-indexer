...
Weapon721.ConsecutiveTransfer.handlerWithLoader({
  loader: async () => ({}),
...
Weapon721.Transfer.handlerWithLoader({
  loader: async () => ({}),
  handler: async ({ event, context }) => {
...
Weapon721.WeaponGenerated.handlerWithLoader({
  loader: async () => ({}),
  handler: async ({ event, context }) => {
...
Weapon721.WeaponMetadataGenerated.handlerWithLoader({
  loader: async ({ event, context }: { event: any; context: any }) => {
    const { id: weaponId } = event.params;
